...
function correct_p135_q1() {
  var q3 = document.getElementById("p135_q0");
...
function correct_p135_q_Shapes() {
  var q1 = document.getElementById("p135_q1");
  var q2 = document.getElementById("p135_q2");
  var q3 = document.getElementById("p135_q3");
  var q4 = document.getElementById("p135_q4");
  var q5 = document.getElementById("p135_q5");
  var q6 = document.getElementById("p135_q6");
  var q7 = document.getElementById("p135_q7");
  var q8 = document.getElementById("p135_q8");
...
if (q2.value.length == 0) {
  ...
  if(q3.value=='7' || q3.value==' '){
  q2.classList.add("green_shadow");
  }
}else if(q2.value=='7'){
  if(q3.value=='1' || q3.value==' '){
    q2.classList.add("green_shadow");
    }
} else {
...
if (q3.value.length == 0) {
  ...
  if(q2.value=='7' || q2.value==' '){
  q3.classList.add("green_shadow");
  }
}else if(q3.value=='7'){
  if(q2.value=='1' || q2.value==' '){
    q3.classList.add("green_shadow");
    }
} else {
  q3.classList.add("red_shadow");
...
if (q4.value.length == 0) {
  ...
  if(q5.value=='5' || q5.value==' '){
  q4.classList.add("green_shadow");
  }
}else if(q4.value=='5'){
  if(q5.value=='3' || q5.value==' '){
    q4.classList.add("green_shadow");
    }
} else {
...
if (q5.value.length == 0) {
  ...
  if(q4.value=='5' || q4.value==' '){
  q5.classList.add("green_shadow");
  }
}else if(q5.value=='5'){
  if(q4.value=='3' || q4.value==' '){
    q5.classList.add("green_shadow");
    }
} else {
